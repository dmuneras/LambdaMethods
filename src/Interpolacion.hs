...
coefSpCuad x fx = eGaussSim (matrizSpCuad x fx) (fromIntegral (length x -1)*3)
...
empalCuadB :: [Double] -> [Double] -> Int -> Int -> [Double]
empalCuadB fx l i n
           | i<=(n-1) = empalCuadB fx (l++[fx!!i,fx!!i]) (i+1) n
           | otherwise = l
...
extCuadB :: [Double] -> Int -> [Double]
extCuadB fx n = [fx!!0,fx!!n]

--Funcion que halla las funciones de las derivadas en los nodos internos. Basada en la practica referenciada
