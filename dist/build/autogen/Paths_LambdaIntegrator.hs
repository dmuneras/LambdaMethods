...
getLibDir = getPrefixDirRel "LambdaIntegrator-0.1.1\\ghc-6.10.1"

getDataDir :: IO FilePath
getDataDir =  catch (getEnv "LambdaIntegrator_datadir") (\_ -> getPrefixDirRel "LambdaIntegrator-0.1.1")

getLibexecDir :: IO FilePath
getLibexecDir = getPrefixDirRel "LambdaIntegrator-0.1.1"
